...
// Normalize base and force single /api prefix (strip trailing slashes and trailing /api if present)
  ...
  function openGoogleMapsDirections() {
    window.open('https://www.google.hu/maps/place/Vecs%C3%A9s,+A%26T+Aut%C3%B3szerviz+%C3%A9s+Gumiszerviz,+Ipar+u+1,+2220/@47.4099056,19.2326917,17z/data=!4m2!3m1!1s0x4741c10b9f9a1c83:0x71542c9df670578b', '_blank');
  }
        ...
        <form class="contact-form" on:submit|preventDefault={handleSubmit}>
          ...
          <div class="captcha-wrapper">
            <div class="captcha-box {isHuman ? 'verified' : ''} {formErrors.captcha ? 'has-error' : ''}">
              <label class="captcha-label" for="captcha-check-service">
                <input
                  type="checkbox"
                  id="captcha-check-service"
