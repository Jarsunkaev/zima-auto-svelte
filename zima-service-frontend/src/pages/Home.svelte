<script>
  ...
  function handleServiceAction(serviceId) {
    ...
    const bookingServiceId =
      serviceId === "tireService" ? "tireService" : "autoService";
...
<section class="faq-home-section" id="home-faq">
  <div class="container">
    <div class="faq-home-head">
      ...
      <p>
        {$currentLang === "hu"
          ? "Szerviz, gumi és autóápolás – a legfontosabb kérdésekre adott válaszaink."
          : "Workshop, tires and detailing — the answers we share most often."}
      </p>
