      ...
      <div class="footer-grid">
        <div class="footer-info">
          <div class="footer-logo">
            <img src="images/newlogblue.png" alt="A&T Group" />
          </div>
          <div class="contact-info">
            ...
            <p>
              ...
              <a href="tel:+36705859959" class="contact-link">+36 70 585 9959</a>,
              <a href="tel:+36707343444" class="contact-link">+36 70 734 3444</a>
            </p>
            <p>
          ...
          <div class="social-links">
            ...
            <a
              href="https://www.instagram.com/zima_auto/"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div class="footer-links">
          ...
          <ul>
            ...
            <li>
              <a
                href="#booking"
                on:click|preventDefault={() => navigate("booking")}
              >
  ...
  <div class="footer-bottom">
    <div class="container">
      ...
      <div class="legal-links">
        <a
          href="#privacy"
          on:click|preventDefault={() => navigate("privacy")}
          class="legal-link"
        >
        ...
        <a
          href="#imprint"
          on:click|preventDefault={() => navigate("imprint")}
          class="legal-link"
        >
