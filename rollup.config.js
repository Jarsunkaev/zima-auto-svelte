...
export default {
	...
	plugins: [
		replace({
			...
			'process.env.VITE_BACKEND_API_URL': JSON.stringify(process.env.VITE_BACKEND_API_URL || 'https://atgroup-backend.fly.dev/api'),
			'import.meta.env.VITE_BACKEND_API_URL': JSON.stringify(process.env.VITE_BACKEND_API_URL || 'https://atgroup-backend.fly.dev/api')
		}),
		svelte({
			compilerOptions: {
