...
<div class="services-container">
  ...
  <!-- Zima Kebab Section -->
  <section class="service-section" id="kebab">
    <div class="container">
      <div class="kebab-header">
        <h2 class="kebab-title">ZIMA KEBAB</h2>
        <p class="kebab-subtitle">
          {$currentLang === 'hu' 
      ...
      <div class="kebab-carousel-container">
        <div class="kebab-carousel">
          {#each Array(8) as _, i}
            <div class="kebab-carousel-item">
              <img 
                src={`/images/bufe${i + 1}.webp`} 
                alt={`Zima Kebab ${i + 1}`}
                loading="lazy"
        ...
        <button class="kebab-carousel-nav prev" on:click={scrollKebabCarousel(-1)} aria-label="Previous">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
          </svg>
        </button>
        <button class="kebab-carousel-nav next" on:click={scrollKebabCarousel(1)} aria-label="Next">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
<style>
  ...
  .kebab-carousel-item:hover {
    transform: translateY(-5px);
  }

  .kebab-carousel-item img {
    width: 100%;
    height: 250px;
    object-fit: cover;
    display: block;
  ...
  .kebab-carousel-nav:hover {
    background: rgba(0, 0, 0, 0.8);
    transform: translateY(-50%) scale(1.1);
  }

  .kebab-carousel-nav.prev {
    left: -50px;
  }

  .kebab-carousel-nav.next {
    right: -50px;
  }
