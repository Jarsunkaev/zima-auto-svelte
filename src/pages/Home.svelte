<script>
  ...
  trustindexScript.src = 'https://cdn.trustindex.io/loader.js?4c886db4520d6718828682314aa';
...
<section class="testimonials-section">
  ...
  <div class="container">
    ...
    <div class="testimonials-footer">
      <button class="btn btn-outline" on:click={toggleReviewsWidget}>
        {#if showReviewsWidget}
          {$currentLang === 'hu' ? 'Elrejtés' : 'Hide reviews'}
        {:else}
    ...
    {#if showReviewsWidget}
  <div class="reviews-dropdown" transition:slide|local>
...
.testimonials-footer .btn {
  ...
  /* Override Trustindex styles if needed */
  :global(#trustindex-widget) {
    width: 100% !important;
  }
