<script>
  ...
  // Handler for service card CTA buttons (open dedicated sites)
      ...
      {#each services as service, i}
        <ServiceCard
          ...
          description={$currentLang === "hu"
            ? service.id === "parking"
              ? "Biztonságos reptéri parkolás ingyenes transzferrel, pár percre a repülőtértől. Bekerített telephely helyszíni személyzettel."
              : service.id === "washing"
            ...
            : service.id === "parking"
              ? "Secure airport parking with free shuttle service, just minutes from the airport. Fenced facility with on-site staff."
              : service.id === "washing"
          ...
          ctaText={$currentLang === "hu" ? "Oldal megtekintése" : "Go to page"}
...
<section class="faq-home-section" id="home-faq">
  <div class="container">
    <div class="faq-home-head">
      ...
      <p>
        {$currentLang === "hu"
          ? "Gyors válaszok a parkolással, szervizzel és foglalással kapcsolatos visszatérő kérdésekre."
          : "Fast answers to the questions we hear most about parking, servicing and booking."}
      </p>
