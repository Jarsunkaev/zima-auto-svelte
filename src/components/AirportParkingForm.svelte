<script>
  ...
  function validateForm() {
    ...
    if (days > 30) {
      formErrors.maxDays = content[currentLang].bookingForm.airportParking.maxDaysExceeded;
      isValid = false;
    }
  ...
  // Reactive check for 30-day limit to show tooltip
  $: exceedsMaxDays = calculateDays() > 30;
